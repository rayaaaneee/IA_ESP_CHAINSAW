...
for filename in filenames:
    with open(f"training/data/chainsaw/{filename}", "r") as f:
...
for filename in filenames:
    with open(f"training/data/environment/motocross_digital/{filename}", "r") as f:
        pass  # Create an empty file for demonstration purposes
...
for filename in filenames:
    with open(f"training/data/environment/lluvia_digital/{filename}", "r") as f:
        pass  # Create an empty file for demonstration purposes
...
for filename in filenames:
    with open(f"training/data/environment/digital_ambience_rainforest_/{filename}", "r") as f:
        pass  # Create an empty file for demonstration purposes
...
for filename in filenames:
    with open(f"training/data/environment/rainforest_atmosphere_beta/{filename}", "r") as f:
        pass  # Create an empty file for demonstration purposes
...
for filename in filenames:
    with open(f"training/data/environment/lluvia_selva_tropical_digital/{filename}", "r") as f:
        pass  # Create an empty file for demonstration purposes
